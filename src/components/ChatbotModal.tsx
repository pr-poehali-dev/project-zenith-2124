      ...
      >
        ...
        <div className="h-[80vh] w-full overflow-hidden rounded-lg flex items-center justify-center bg-gray-900">
          <div className="text-center text-white p-8">
            ...
            <p className="text-xl mb-4 font-semibold">Онлайн-консультант</p>
            <p className="text-gray-400 mb-2">Здесь скоро появится наш онлайн-консультант.</p>
            <p className="text-gray-400">По срочным вопросам свяжитесь с нами напрямую:</p>
            <p className="text-white font-semibold mt-4 text-lg">📞 Позвоните нам</p>
            <p className="text-gray-500 mt-2 text-sm">или оставьте заявку через форму на сайте</p>
          </div>
        </div>
      </div>
    </div>
